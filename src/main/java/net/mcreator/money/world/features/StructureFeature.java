...
import net.mcreator.money.world.features.configurations.StructureFeatureConfiguration;
import net.mcreator.money.MoneyMod;

import com.mojang.serialization.Codec;

public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, MoneyMod.MODID);
