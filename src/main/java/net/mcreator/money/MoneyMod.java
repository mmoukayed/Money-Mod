...
import net.mcreator.money.world.features.StructureFeature;
import net.mcreator.money.network.MoneyModVariables;
import net.mcreator.money.init.MoneyModTabs;
...
public class MoneyMod {
	...
	public MoneyMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		MoneyModBlocks.REGISTRY.register(modEventBus);
		MoneyModBlockEntities.REGISTRY.register(modEventBus);
		MoneyModItems.REGISTRY.register(modEventBus);
		MoneyModTabs.REGISTRY.register(modEventBus);
		MoneyModVariables.ATTACHMENT_TYPES.register(modEventBus);
		StructureFeature.REGISTRY.register(modEventBus);
		MoneyModMenus.REGISTRY.register(modEventBus);
